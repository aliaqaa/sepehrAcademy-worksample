      ...
      <img
        ...
        <div className="flex justify-center items-center gap-20 p-2 content-center "> 
          {FavoriteCats.map((item) => (
            <div key={item.id} className="rotate-45 flex flex-col  justify-center rounded-3xl bg-slate-50 p-10 items-center w-40 h-40 hover:bg-orange-400 shadow-inner mt-36">
